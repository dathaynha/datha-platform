(<any>window).ENV = {
  ...
  gateway: {
    baseUrl: "https://api-int.example.com",
    filesBaseUrl: "https://api-int.example.com/api/files",
  },
  entraOidc: {
    ...
    responseType: "code",
    requireHttps: true,
    redirectUri: "https://shell-int.example.com",
    tokenProxyUrl: "https://api-int.example.com/auth/entra/token",
  },
  googleOidc: {
    ...
    requireHttps: true,
    redirectUri: "https://shell-int.example.com",
    tokenProxyUrl: "https://api-int.example.com/auth/google/token",
  },
  oauth: {
    ignoreUrls: {
      urls: [
  ...
  remotes: {
    chatbot: "https://chatbot-int.example.com/remoteEntry.js",
    "event-store": "https://event-store-int.example.com/remoteEntry.js",
    messenger: "https://messenger-int.example.com/remoteEntry.js",
  },
  /**

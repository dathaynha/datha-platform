(<any>window).ENV = {
  ...
  version: "1.0.0",
  gateway: {
    baseUrl: "https://gateway.example.com/api/messenger",
  ...
  realtime: {
    tokenUrl: "https://gateway.example.com/api/realtime/token",
    socketUrl: "wss://gateway.example.com/api/realtime/ws",
  },
  entraOidc: {
    ...
    responseType: "code",
    requireHttps: true,
    redirectUri: "https://messenger.example.com",

...
(<any>window).ENV = {
  ...
  version: "1.0.0",
  gateway: {
    baseUrl: "http://localhost:8080/api/messenger",
  ...
  realtime: {
    tokenUrl: "http://localhost:8080/api/realtime/token",
    socketUrl: "ws://localhost:8080/api/realtime/ws",
  },
  entraOidc: {
    ...
    responseType: "code",
    requireHttps: false,
    redirectUri: "http://localhost:4003",
